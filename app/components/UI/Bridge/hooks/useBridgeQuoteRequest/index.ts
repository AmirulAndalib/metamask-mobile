...
export const useBridgeQuoteRequest = (
  ...
  // // Only handle refresh because SwapQuotesProvider handles controller updates
  // if (maybeSwapQuotes) {
  //   return (params?: { isRefresh?: boolean }) =>
  //     params?.isRefresh ? maybeSwapQuotes.refreshQuotes : undefined;
  // }
